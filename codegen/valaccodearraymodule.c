                                                    ...
                                                    ValaArrayType* array_type)
{
	...
	if (vala_ccode_base_module_requires_copy (_tmp37_)) {
		...
		ValaCCodeBinaryOperator _tmp90_;
		...
		ValaCCodeElementAccess* _tmp142_;
		...
		_tmp90_ = length_check_op;
		_tmp91_ = vala_ccode_identifier_new ("length");
		_tmp92_ = _tmp91_;
		_tmp93_ = vala_ccode_constant_new ("0");
		_tmp94_ = _tmp93_;
		_tmp95_ = vala_ccode_binary_expression_new (_tmp90_, (ValaCCodeExpression*) _tmp92_, (ValaCCodeExpression*) _tmp94_);
		_tmp96_ = _tmp95_;
		_vala_ccode_node_unref0 (_tmp94_);
		_vala_ccode_node_unref0 (_tmp92_);
		length_check = _tmp96_;
		_tmp97_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp98_ = _tmp97_;
		_tmp99_ = length_check;
		...
		_tmp101_ = _tmp100_;
		_tmp102_ = vala_get_ccode_name ((ValaCodeNode*) array_type);
		_tmp103_ = _tmp102_;
		_tmp104_ = cvardecl;
		vala_ccode_function_add_declaration (_tmp101_, _tmp103_, (ValaCCodeDeclarator*) _tmp104_, 0);
		_g_free0 (_tmp103_);
		_tmp105_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp106_ = _tmp105_;
		_tmp107_ = vala_ccode_identifier_new ("result");
		_tmp108_ = _tmp107_;
		_tmp109_ = gnew;
		...
		_tmp111_ = _tmp110_;
		_tmp112_ = ((ValaCCodeBaseModule*) self)->ssize_t_type;
		_tmp113_ = vala_get_ccode_name ((ValaCodeNode*) _tmp112_);
		_tmp114_ = _tmp113_;
		_tmp115_ = vala_ccode_variable_declarator_new ("i", NULL, NULL);
		_tmp116_ = _tmp115_;
		vala_ccode_function_add_declaration (_tmp111_, _tmp114_, (ValaCCodeDeclarator*) _tmp116_, 0);
		_vala_ccode_node_unref0 (_tmp116_);
		_g_free0 (_tmp114_);
		_tmp117_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp118_ = _tmp117_;
		_tmp119_ = vala_ccode_identifier_new ("i");
		_tmp120_ = _tmp119_;
		_tmp121_ = vala_ccode_constant_new ("0");
		_tmp122_ = _tmp121_;
		_tmp123_ = vala_ccode_assignment_new ((ValaCCodeExpression*) _tmp120_, (ValaCCodeExpression*) _tmp122_, VALA_CCODE_ASSIGNMENT_OPERATOR_SIMPLE);
		_tmp124_ = _tmp123_;
		_tmp125_ = vala_ccode_identifier_new ("i");
		_tmp126_ = _tmp125_;
		_tmp127_ = vala_ccode_identifier_new ("length");
		_tmp128_ = _tmp127_;
		_tmp129_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_LESS_THAN, (ValaCCodeExpression*) _tmp126_, (ValaCCodeExpression*) _tmp128_);
		_tmp130_ = _tmp129_;
		_tmp131_ = vala_ccode_identifier_new ("i");
		_tmp132_ = _tmp131_;
		_tmp133_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_POSTFIX_INCREMENT, (ValaCCodeExpression*) _tmp132_);
		_tmp134_ = _tmp133_;
		vala_ccode_function_open_for (_tmp118_, (ValaCCodeExpression*) _tmp124_, (ValaCCodeExpression*) _tmp130_, (ValaCCodeExpression*) _tmp134_);
		...
		_tmp138_ = _tmp137_;
		_tmp139_ = vala_ccode_identifier_new ("i");
		_tmp140_ = _tmp139_;
		_tmp141_ = vala_ccode_element_access_new ((ValaCCodeExpression*) _tmp138_, (ValaCCodeExpression*) _tmp140_);
		_tmp142_ = _tmp141_;
		_tmp143_ = vala_array_type_get_element_type (array_type);
		_tmp144_ = _tmp143_;
		_tmp145_ = vala_ccode_identifier_new ("self");
		_tmp146_ = _tmp145_;
		_tmp147_ = vala_ccode_identifier_new ("i");
		_tmp148_ = _tmp147_;
		_tmp149_ = vala_ccode_element_access_new ((ValaCCodeExpression*) _tmp146_, (ValaCCodeExpression*) _tmp148_);
		_tmp150_ = _tmp149_;
		_tmp151_ = vala_glib_value_new (_tmp144_, (ValaCCodeExpression*) _tmp150_, TRUE);
		_tmp152_ = _tmp151_;
		_tmp153_ = vala_ccode_base_module_copy_value ((ValaCCodeBaseModule*) self, (ValaTargetValue*) _tmp152_, (ValaCodeNode*) array_type);
		_tmp154_ = _tmp153_;
		_tmp155_ = vala_get_cvalue_ (_tmp154_);
		vala_ccode_function_add_assignment (_tmp136_, (ValaCCodeExpression*) _tmp142_, _tmp155_);
		_vala_target_value_unref0 (_tmp154_);
		_vala_target_value_unref0 (_tmp152_);
		...
		_tmp157_ = _tmp156_;
		vala_ccode_function_close (_tmp157_);
		_tmp158_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp159_ = _tmp158_;
		_tmp160_ = vala_ccode_identifier_new ("result");
		_tmp161_ = _tmp160_;
		vala_ccode_function_add_return (_tmp159_, (ValaCCodeExpression*) _tmp161_);
		...
		_tmp167_ = _tmp166_;
		vala_ccode_function_add_return (_tmp165_, (ValaCCodeExpression*) _tmp167_);
		...
		_tmp168_ = vala_ccode_identifier_new ("length");
		_tmp169_ = _tmp168_;
		_tmp170_ = vala_ccode_constant_new ("0");
		_tmp171_ = _tmp170_;
		_tmp172_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_GREATER_THAN, (ValaCCodeExpression*) _tmp169_, (ValaCCodeExpression*) _tmp171_);
		_tmp173_ = _tmp172_;
		_vala_ccode_node_unref0 (_tmp171_);
		_vala_ccode_node_unref0 (_tmp169_);
		length_check = _tmp173_;
		_tmp174_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
		_tmp175_ = _tmp174_;
		_tmp176_ = length_check;
		vala_ccode_function_open_if (_tmp175_, (ValaCCodeExpression*) _tmp176_);
		_tmp177_ = vala_ccode_identifier_new ("sizeof");
		_tmp178_ = _tmp177_;
		_tmp179_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp178_);
		_tmp180_ = _tmp179_;
		_vala_ccode_node_unref0 (_tmp178_);
		sizeof_call = _tmp180_;
		_tmp181_ = sizeof_call;
		_tmp182_ = vala_array_type_get_element_type (array_type);
		_tmp183_ = _tmp182_;
		_tmp184_ = vala_get_ccode_name ((ValaCodeNode*) _tmp183_);
		_tmp185_ = _tmp184_;
		_tmp186_ = vala_ccode_identifier_new (_tmp185_);
		_tmp187_ = _tmp186_;
		vala_ccode_function_call_add_argument (_tmp181_, (ValaCCodeExpression*) _tmp187_);
		_vala_ccode_node_unref0 (_tmp187_);
		_g_free0 (_tmp185_);
		_tmp188_ = vala_ccode_identifier_new ("length");
		length_expr = _tmp188_;
		_tmp189_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
		_tmp190_ = _tmp189_;
		_tmp191_ = vala_code_context_get_profile (_tmp190_);
		_tmp192_ = _tmp191_;
		if (_tmp192_ == VALA_PROFILE_POSIX) {
			...
			ValaCCodeBinaryExpression* _tmp228_;
			...
			vala_ccode_file_add_include (_tmp193_, "stdlib.h", FALSE);
			_tmp194_ = ((ValaCCodeBaseModule*) self)->cfile;
			vala_ccode_file_add_include (_tmp194_, "string.h", FALSE);
			_tmp195_ = vala_ccode_identifier_new ("calloc");
			_tmp196_ = _tmp195_;
			...
			alloc = _tmp198_;
			_tmp199_ = alloc;
			_tmp200_ = length_expr;
			vala_ccode_function_call_add_argument (_tmp199_, (ValaCCodeExpression*) _tmp200_);
			_tmp201_ = alloc;
			_tmp202_ = sizeof_call;
			vala_ccode_function_call_add_argument (_tmp201_, (ValaCCodeExpression*) _tmp202_);
			_tmp203_ = vala_ccode_variable_declarator_new ("result", NULL, NULL);
			cvardecl = _tmp203_;
			_tmp204_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp205_ = _tmp204_;
			_tmp206_ = vala_get_ccode_name ((ValaCodeNode*) array_type);
			_tmp207_ = _tmp206_;
			_tmp208_ = cvardecl;
			vala_ccode_function_add_declaration (_tmp205_, _tmp207_, (ValaCCodeDeclarator*) _tmp208_, 0);
			_g_free0 (_tmp207_);
			...
			_tmp214_ = vala_ccode_identifier_new ("memcpy");
			_tmp215_ = _tmp214_;
			...
			dup_call = _tmp217_;
			_tmp218_ = dup_call;
			_tmp219_ = vala_ccode_identifier_new ("result");
			_tmp220_ = _tmp219_;
			vala_ccode_function_call_add_argument (_tmp218_, (ValaCCodeExpression*) _tmp220_);
			_vala_ccode_node_unref0 (_tmp220_);
			_tmp221_ = dup_call;
			_tmp222_ = vala_ccode_identifier_new ("self");
			_tmp223_ = _tmp222_;
			vala_ccode_function_call_add_argument (_tmp221_, (ValaCCodeExpression*) _tmp223_);
			_vala_ccode_node_unref0 (_tmp223_);
			_tmp224_ = dup_call;
			_tmp225_ = length_expr;
			_tmp226_ = sizeof_call;
			_tmp227_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) _tmp225_, (ValaCCodeExpression*) _tmp226_);
			_tmp228_ = _tmp227_;
			vala_ccode_function_call_add_argument (_tmp224_, (ValaCCodeExpression*) _tmp228_);
			...
			_tmp233_ = _tmp232_;
			_tmp234_ = vala_ccode_identifier_new ("result");
			_tmp235_ = _tmp234_;
			vala_ccode_function_add_return (_tmp233_, (ValaCCodeExpression*) _tmp235_);
			...
			_tmp237_ = _tmp236_;
			if (vala_code_context_require_glib_version (_tmp237_, 2, 68)) {
				ValaCCodeIdentifier* _tmp238_;
				ValaCCodeIdentifier* _tmp239_;
				ValaCCodeFunctionCall* _tmp240_;
				_tmp238_ = vala_ccode_identifier_new ("g_memdup2");
				_tmp239_ = _tmp238_;
				_tmp240_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp239_);
				_vala_ccode_node_unref0 (dup_call);
				dup_call = _tmp240_;
				...
				_tmp241_ = vala_ccode_identifier_new ("_vala_memdup2");
				_tmp242_ = _tmp241_;
			...
			_tmp247_ = dup_call;
			_tmp248_ = length_expr;
			_tmp249_ = sizeof_call;
			_tmp250_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_MUL, (ValaCCodeExpression*) _tmp248_, (ValaCCodeExpression*) _tmp249_);
			_tmp251_ = _tmp250_;
			...
			_tmp253_ = _tmp252_;
			_tmp254_ = dup_call;
			vala_ccode_function_add_return (_tmp253_, (ValaCCodeExpression*) _tmp254_);
			_vala_ccode_node_unref0 (dup_call);
		}
		...
		_tmp260_ = _tmp259_;
		vala_ccode_function_add_return (_tmp258_, (ValaCCodeExpression*) _tmp260_);
	...
	_tmp262_ = function;
	vala_ccode_file_add_function_declaration (_tmp261_, _tmp262_);
	_tmp263_ = ((ValaCCodeBaseModule*) self)->cfile;
	_tmp264_ = function;
	vala_ccode_file_add_function (_tmp263_, _tmp264_);
