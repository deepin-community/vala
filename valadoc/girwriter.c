                                               ...
                                               ValaParameter* param)
{
	...
	taglets = _tmp12_;
	{
		...
		_tmp13_ = taglets;
		__taglet_list = _tmp13_;
		_tmp14_ = __taglet_list;
		_tmp15_ = vala_collection_get_size ((ValaCollection*) _tmp14_);
		_tmp16_ = _tmp15_;
		__taglet_size = _tmp16_;
		__taglet_index = -1;
		while (TRUE) {
			gint _tmp17_;
			gint _tmp18_;
			...
			_tmp17_ = __taglet_index;
			_tmp18_ = __taglet_size;
			if (!(_tmp17_ < _tmp18_)) {
				break;
			}
			_tmp19_ = __taglet_list;
			_tmp20_ = vala_list_get (_tmp19_, __taglet_index);
			_taglet = (ValadocContentTaglet*) _tmp20_;
			_tmp21_ = _taglet;
			_tmp22_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp21_, VALADOC_TAGLETS_TYPE_PARAM, ValadocTagletsParam));
			taglet = _tmp22_;
			_tmp23_ = taglet;
			_tmp24_ = valadoc_taglets_param_get_parameter_name (_tmp23_);
			_tmp25_ = _tmp24_;
			...
			if (g_strcmp0 (_tmp25_, _tmp27_) == 0) {
				...
				gchar* _tmp29_;
				_tmp28_ = taglet;
				_tmp29_ = valadoc_gir_writer_translate_taglet (self, (ValadocContentTaglet*) _tmp28_);
				result = _tmp29_;
				_g_object_unref0 (taglet);
