...
VALA_EXTERN gboolean gtkdoc_config_nohtml;
gboolean gtkdoc_config_nohtml = FALSE;
VALA_EXTERN gchar** gtkdoc_config_library_filenames;
gchar** gtkdoc_config_library_filenames = NULL;
VALA_EXTERN gchar** gtkdoc_config_ignore_headers;
gchar** gtkdoc_config_ignore_headers = NULL;
VALA_EXTERN gchar** gtkdoc_config_source_files;
gchar** gtkdoc_config_source_files = NULL;
VALA_EXTERN gchar* gtkdoc_config_deprecated_guards;
gchar* gtkdoc_config_deprecated_guards = NULL;
VALA_EXTERN gchar* gtkdoc_config_ignore_decorators;
...
VALA_EXTERN gboolean gtkdoc_config_parse (gchar** rargs,
                              gint rargs_length1,
                              ValadocErrorReporter* reporter);
static void _vala_array_add3 (gchar** * array,
                       ...
                       gint* size,
                       gchar* value);
VALA_EXTERN GType gtkdoc_director_get_type (void) G_GNUC_CONST ;
...
static void gtkdoc_director_prepare_c_file (GtkdocDirector* self,
                                     ...
                                     const gchar* comments_dir);
VALA_EXTERN gboolean gtkdoc_is_generated_by_vala (const gchar* filename);
...
static void _vala_array_add12 (gchar** * array,
                        ...
                        gint* size,
                        gchar* value);
VALA_EXTERN gboolean gtkdoc_package_exists (const gchar* package_name,
                                ValadocErrorReporter* reporter);
...
VALA_EXTERN GtkdocDirector* gtkdoc_director_new (void);
VALA_EXTERN GtkdocDirector* gtkdoc_director_construct (GType object_type);
...
const GOptionEntry GTKDOC_CONFIG_options[7] = {{"library", 'l', (gint) 0, G_OPTION_ARG_FILENAME_ARRAY, &gtkdoc_config_library_filenames, "Shared library path", "FILENAME"}, {"ignore-headers", 'x', (gint) 0, G_OPTION_ARG_FILENAME_ARRAY, &gtkdoc_config_ignore_headers, "A list of header files to not scan", "FILES"}, {"deprecated-guards", 'd', (gint) 0, G_OPTION_ARG_STRING, &gtkdoc_config_deprecated_guards, "A |-separated list of symbols used as deprecation guards", "GUARDS"}, {"ignore-decorators", (gchar) 0, (gint) 0, G_OPTION_ARG_STRING, &gtkdoc_config_ignore_decorators, "A |-separated list of addition decorators in declarations that should " \
"be ignored", "DECS"}, {"no-html", (gchar) 0, (gint) 0, G_OPTION_ARG_NONE, &gtkdoc_config_nohtml, "Disable HTML generation", NULL}, {G_OPTION_REMAINING, (gchar) 0, (gint) 0, G_OPTION_ARG_FILENAME_ARRAY, &gtkdoc_config_source_files, NULL, "FILE..."}, {NULL}};
...
gtkdoc_director_mkdb (GtkdocDirector* self)
{
	...
	if (must_update_main_file) {
		...
		if (_tmp61_ > 0) {
			...
			g_string_append_printf (_tmp63_, "\n<chapter>\n<title>%s D-Bus API Reference</title>\n", _tmp65_);
			{
				...
				while (TRUE) {
					...
					iface = (GtkdocDBusInterface*) _tmp74_;
					_tmp75_ = builder;
					_tmp76_ = iface;
					_tmp77_ = _tmp76_->name;
					_tmp78_ = gtkdoc_to_docbook_id (_tmp77_);
					_tmp79_ = _tmp78_;
					g_string_append_printf (_tmp75_, "<xi:include href=\"xml/%s.xml\"/>\n", _tmp79_);
					_g_free0 (_tmp79_);
			...
			_tmp83_ = _tmp82_->pkg_name;
			_tmp84_ = g_strdup_printf ("%s.hierarchy", _tmp83_);
			_tmp85_ = _tmp84_;
			_tmp86_ = g_build_filename (_tmp81_, _tmp85_, NULL);
			_tmp87_ = _tmp86_;
			_g_free0 (_tmp85_);
			hierarchy_file = _tmp87_;
			_tmp88_ = hierarchy_file;
			if (g_file_test (_tmp88_, G_FILE_TEST_EXISTS)) {
				...
				gchar* _tmp93_;
				_tmp89_ = builder;
				g_string_append (_tmp89_, "</chapter>\n<chapter id=\"object-tree\">");
				_tmp90_ = contents;
				_tmp91_ = builder;
				_tmp92_ = _tmp91_->str;
				_tmp93_ = string_replace (_tmp90_, "<chapter id=\"object-tree\">", _tmp92_);
				_g_free0 (contents);
				contents = _tmp93_;
			} else {
				GString* _tmp94_;
				...
				gchar* _tmp98_;
				_tmp94_ = builder;
				g_string_append (_tmp94_, "</chapter>\n<index id=\"api-index-full\">");
				_tmp95_ = contents;
				_tmp96_ = builder;
				_tmp97_ = _tmp96_->str;
				_tmp98_ = string_replace (_tmp95_, "<index id=\"api-index-full\">", _tmp97_);
				_g_free0 (contents);
				contents = _tmp98_;
			}
		...
		}
		{
			...
			_tmp99_ = main_file;
			_tmp100_ = contents;
			g_file_set_contents (_tmp99_, _tmp100_, (gssize) -1, &_inner_error0_);
			if (G_UNLIKELY (_inner_error0_ != NULL)) {
		...
		__catch2_g_error:
		{
			...
			e = _inner_error0_;
			_inner_error0_ = NULL;
			_tmp101_ = self->priv->reporter;
			_tmp102_ = main_file;
			_tmp103_ = e;
			_tmp104_ = _tmp103_->message;
			valadoc_error_reporter_simple_error (_tmp101_, "GtkDoc", "Error while writing main file '%s' contents: %s", _tmp102_, _tmp104_);
			result = FALSE;
			_g_error_free0 (e);
			_g_free0 (contents);
			args = (_vala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
