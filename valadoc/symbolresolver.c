...
VALA_EXTERN ValadocApiSymbol* valadoc_symbol_resolver_resolve (ValadocSymbolResolver* self,
                                                   ValaSymbol* symbol);
                                             ...
                                             ValaSymbol* vala_symbol)
{
	...
	vala_code_node_get_error_types ((ValaCodeNode*) vala_symbol, (ValaCollection*) _tmp2_, NULL);
	{
		...
		while (TRUE) {
			...
			_tmp9_ = _type_list;
			_tmp10_ = vala_list_get ((ValaList*) _tmp9_, _type_index);
			type = (ValaDataType*) _tmp10_;
			_tmp11_ = type;
			_tmp12_ = vala_error_type_get_error_domain (G_TYPE_CHECK_INSTANCE_CAST (_tmp11_, VALA_TYPE_ERROR_TYPE, ValaErrorType));
			_tmp13_ = _tmp12_;
			vala_edom = _tmp13_;
...
{
	static volatile gsize valadoc_symbol_resolver_type_id__once = 0;
	if (g_once_init_enter (&valadoc_symbol_resolver_type_id__once)) {
		GType valadoc_symbol_resolver_type_id;
		valadoc_symbol_resolver_type_id = valadoc_symbol_resolver_get_type_once ();
		g_once_init_leave (&valadoc_symbol_resolver_type_id__once, valadoc_symbol_resolver_type_id);
	}
	return valadoc_symbol_resolver_type_id__once;
}
