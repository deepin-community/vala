...
valadoc_charts_simple_factory_configure_type (ValadocChartsSimpleFactory* self,
                                              ...
                                              ValadocApiNode* item)
{
	ValadocChartsSimpleFactoryClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_SIMPLE_FACTORY_GET_CLASS (self);
	if (_klass_->configure_type) {
		return _klass_->configure_type (self, node, item);
	}
	return NULL;
}
