...
valadoc_charts_factory_create_graph (ValadocChartsFactory* self,
                                     ValadocApiNode* item)
{
	ValadocChartsFactoryClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_graph) {
		return _klass_->create_graph (self, item);
	}
	return NULL;
}
                                       ...
                                       Agraph_t* graph)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_context) {
		return _klass_->create_context (self, graph);
	}
	return NULL;
}
                                     ...
                                     ValadocApiClass* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_class) {
		return _klass_->create_class (self, graph, item);
	}
	return NULL;
}
                                      ...
                                      ValadocApiStruct* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_struct) {
		return _klass_->create_struct (self, graph, item);
	}
	return NULL;
}
                                         ...
                                         ValadocApiInterface* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_interface) {
		return _klass_->create_interface (self, graph, item);
	}
	return NULL;
}
                                    ...
                                    ValadocApiEnum* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_enum) {
		return _klass_->create_enum (self, graph, item);
	}
	return NULL;
}
                                        ...
                                        ValadocApiDelegate* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_delegate) {
		return _klass_->create_delegate (self, graph, item);
	}
	return NULL;
}
                                           ...
                                           ValadocApiErrorDomain* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_errordomain) {
		return _klass_->create_errordomain (self, graph, item);
	}
	return NULL;
}
                                         ...
                                         ValadocApiNamespace* item)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->create_namespace) {
		return _klass_->create_namespace (self, graph, item);
	}
	return NULL;
}
                                     ...
                                     Agnode_t* child)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CHARTS_FACTORY_GET_CLASS (self);
	if (_klass_->add_children) {
		return _klass_->add_children (self, graph, parent, child);
	}
	return NULL;
}
