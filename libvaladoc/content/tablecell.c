                                      ...
                                      ValadocContentContentElement* new_parent)
{
	...
	valadoc_content_style_attributes_set_style ((ValadocContentStyleAttributes*) _tmp12_, _tmp14_);
	{
		...
		while (TRUE) {
			...
			ValadocContentTableCell* _tmp25_;
			...
			_tmp20_ = _element_index;
			_tmp21_ = _element_size;
			if (!(_tmp20_ < _tmp21_)) {
				break;
			}
			_tmp22_ = _element_list;
			_tmp23_ = vala_list_get (_tmp22_, _element_index);
			element = (ValadocContentInline*) _tmp23_;
			_tmp24_ = element;
			_tmp25_ = cell;
			_tmp26_ = valadoc_content_content_element_copy ((ValadocContentContentElement*) _tmp24_, (ValadocContentContentElement*) _tmp25_);
			_tmp27_ = VALADOC_CONTENT_IS_INLINE (_tmp26_) ? ((ValadocContentInline*) _tmp26_) : NULL;
			if (_tmp27_ == NULL) {
