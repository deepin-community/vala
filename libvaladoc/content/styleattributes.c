...
{
	ValadocContentStyleAttributesIface* _iface_;
	g_return_val_if_fail (self != NULL, 0);
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->get_horizontal_align) {
		return _iface_->get_horizontal_align (self);
	}
	return 0;
}
                                                       ...
                                                       ValadocContentHorizontalAlign value)
{
	...
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->set_horizontal_align) {
		_iface_->set_horizontal_align (self, value);
	}
}
...
valadoc_content_style_attributes_get_vertical_align (ValadocContentStyleAttributes* self)
{
	...
	g_return_val_if_fail (self != NULL, 0);
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->get_vertical_align) {
		return _iface_->get_vertical_align (self);
	}
	return 0;
}
                                                     ...
                                                     ValadocContentVerticalAlign value)
{
	...
	g_return_if_fail (self != NULL);
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->set_vertical_align) {
		_iface_->set_vertical_align (self, value);
	}
}
...
valadoc_content_style_attributes_get_style (ValadocContentStyleAttributes* self)
{
	...
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->get_style) {
		return _iface_->get_style (self);
	}
	return NULL;
}
                                            ...
                                            const gchar* value)
{
	...
	g_return_if_fail (self != NULL);
	_iface_ = VALADOC_CONTENT_STYLE_ATTRIBUTES_GET_INTERFACE (self);
	if (_iface_->set_style) {
		_iface_->set_style (self, value);
	}
}
