                                     ...
                                     ValadocContentContentElement* new_parent)
{
	...
	valadoc_content_style_attributes_set_style ((ValadocContentStyleAttributes*) _tmp8_, _tmp10_);
	{
		...
		while (TRUE) {
			...
			_tmp19_ = vala_list_get (_tmp18_, _element_index);
			element = (ValadocContentInline*) _tmp19_;
			_tmp20_ = element;
			_tmp21_ = p;
			_tmp22_ = valadoc_content_content_element_copy ((ValadocContentContentElement*) _tmp20_, (ValadocContentContentElement*) _tmp21_);
			_tmp23_ = VALADOC_CONTENT_IS_INLINE (_tmp22_) ? ((ValadocContentInline*) _tmp22_) : NULL;
			if (_tmp23_ == NULL) {
...
{
	static volatile gsize valadoc_content_paragraph_type_id__once = 0;
	if (g_once_init_enter (&valadoc_content_paragraph_type_id__once)) {
		GType valadoc_content_paragraph_type_id;
		valadoc_content_paragraph_type_id = valadoc_content_paragraph_get_type_once ();
		g_once_init_leave (&valadoc_content_paragraph_type_id__once, valadoc_content_paragraph_type_id);
	}
	return valadoc_content_paragraph_type_id__once;
}
