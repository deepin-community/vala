...
valadoc_content_content_element_copy (ValadocContentContentElement* self,
                                      ValadocContentContentElement* new_parent)
{
	ValadocContentContentElementClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_CONTENT_CONTENT_ELEMENT_GET_CLASS (self);
	if (_klass_->copy) {
		return _klass_->copy (self, new_parent);
	}
	return NULL;
}
                                           ...
                                           ValadocResourceLocator* locator)
{
	...
	if (_klass_->configure) {
		_klass_->configure (self, settings, locator);
	}
}
                                       ...
                                       ValadocSettings* settings)
{
	...
	_klass_ = VALADOC_CONTENT_CONTENT_ELEMENT_GET_CLASS (self);
	if (_klass_->check) {
		_klass_->check (self, api_root, container, file_path, reporter, settings);
	}
}
...
{
	static volatile gsize valadoc_content_content_element_type_id__once = 0;
	if (g_once_init_enter (&valadoc_content_content_element_type_id__once)) {
		GType valadoc_content_content_element_type_id;
		valadoc_content_content_element_type_id = valadoc_content_content_element_get_type_once ();
		g_once_init_leave (&valadoc_content_content_element_type_id__once, valadoc_content_content_element_type_id);
	}
	return valadoc_content_content_element_type_id__once;
}
