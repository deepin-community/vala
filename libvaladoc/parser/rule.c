...
{
	ValadocRuleClass* _klass_;
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_RULE_GET_CLASS (self);
	if (_klass_->is_optional) {
		return _klass_->is_optional (self);
	}
	return FALSE;
}
                                ...
                                ValadocToken* token)
{
	...
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_RULE_GET_CLASS (self);
	if (_klass_->starts_with_token) {
		return _klass_->starts_with_token (self, token);
	}
	return FALSE;
}
                           ...
                           GError** error)
{
	...
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_RULE_GET_CLASS (self);
	if (_klass_->accept_token) {
		return _klass_->accept_token (self, token, parser, forward, error);
	}
	return FALSE;
}
                                 ...
                                 GObject* state)
{
	...
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_RULE_GET_CLASS (self);
	if (_klass_->would_accept_token) {
		return _klass_->would_accept_token (self, token, state);
	}
	return FALSE;
}
                           ...
                           GObject* state)
{
	...
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_RULE_GET_CLASS (self);
	if (_klass_->would_reduce) {
		return _klass_->would_reduce (self, token, state);
	}
	return FALSE;
}
                        ...
                        GObject* state)
{
	...
	if (_klass_->to_string) {
		return _klass_->to_string (self, state);
	}
	return NULL;
}
