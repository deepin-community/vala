...
valadoc_html_link_helper_get_package_link (ValadocHtmlLinkHelper* self,
                                           ...
                                           ValadocSettings* settings)
{
	ValadocHtmlLinkHelperClass* _klass_;
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->get_package_link) {
		return _klass_->get_package_link (self, package, settings);
	}
	return NULL;
}
                                                  ...
                                                  ValadocApiPackage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_package_to_package) {
		return _klass_->from_package_to_package (self, from, to);
	}
	return NULL;
}
                                               ...
                                               ValadocWikiPage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_package_to_wiki) {
		return _klass_->from_package_to_wiki (self, from, to);
	}
	return NULL;
}
                                               ...
                                               ValadocApiNode* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_package_to_node) {
		return _klass_->from_package_to_node (self, from, to);
	}
	return NULL;
}
                                               ...
                                               ValadocApiPackage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_wiki_to_package) {
		return _klass_->from_wiki_to_package (self, from, to);
	}
	return NULL;
}
                                            ...
                                            ValadocWikiPage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_wiki_to_wiki) {
		return _klass_->from_wiki_to_wiki (self, from, to);
	}
	return NULL;
}
                                            ...
                                            ValadocApiNode* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_wiki_to_node) {
		return _klass_->from_wiki_to_node (self, from, to);
	}
	return NULL;
}
                                               ...
                                               ValadocApiPackage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_node_to_package) {
		return _klass_->from_node_to_package (self, from, to);
	}
	return NULL;
}
                                            ...
                                            ValadocWikiPage* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_node_to_wiki) {
		return _klass_->from_node_to_wiki (self, from, to);
	}
	return NULL;
}
                                            ...
                                            ValadocApiNode* to)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_klass_ = VALADOC_HTML_LINK_HELPER_GET_CLASS (self);
	if (_klass_->from_node_to_node) {
		return _klass_->from_node_to_node (self, from, to);
	}
	return NULL;
}
