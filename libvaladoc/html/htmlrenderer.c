                                                 ...
                                                 ValadocContentListItem* element)
{
	...
	if (_tmp12_ != NULL) {
		...
		first_entry = TRUE;
		{
			...
			while (TRUE) {
				...
				_tmp21_ = _item_list;
				_tmp22_ = vala_list_get (_tmp21_, _item_index);
				item = (ValadocContentBlock*) _tmp22_;
				if (!first_entry) {
					ValadocContentBlock* _tmp23_;
					_tmp23_ = item;
					valadoc_content_content_element_accept ((ValadocContentContentElement*) _tmp23_, (ValadocContentContentVisitor*) self);
				}
				first_entry = FALSE;
	...
	_tmp24_ = self->writer;
	valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp24_, "li");
