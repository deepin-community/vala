...
valadoc_markup_writer_inline_element (ValadocMarkupWriter* self,
                                      const gchar* name)
{
	ValadocMarkupWriterClass* _klass_;
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_MARKUP_WRITER_GET_CLASS (self);
	if (_klass_->inline_element) {
		return _klass_->inline_element (self, name);
	}
	return FALSE;
}
                                              ...
                                              const gchar* name)
{
	...
	g_return_val_if_fail (self != NULL, FALSE);
	_klass_ = VALADOC_MARKUP_WRITER_GET_CLASS (self);
	if (_klass_->content_inline_element) {
		return _klass_->content_inline_element (self, name);
	}
	return FALSE;
}
