                                      ...
                                      ValaList* taglets)
{
	...
	g_return_if_fail (taglets != NULL);
	{
		...
		__taglet_list = taglets;
		_tmp0_ = __taglet_list;
		_tmp1_ = vala_collection_get_size ((ValaCollection*) _tmp0_);
		_tmp2_ = _tmp1_;
		__taglet_size = _tmp2_;
		__taglet_index = -1;
		while (TRUE) {
			gint _tmp3_;
			gint _tmp4_;
			...
			ValadocTagletsSince* _tmp8_;
			gboolean _tmp9_ = FALSE;
			ValadocTagletsSince* _tmp10_;
			ValadocGtkDocMarkupWriter* _tmp15_;
			ValadocGtkDocMarkupWriter* _tmp16_;
			ValadocMarkupWriter* _tmp17_;
			ValadocTagletsSince* _tmp18_;
			const gchar* _tmp19_;
			const gchar* _tmp20_;
			ValadocGtkDocMarkupWriter* _tmp21_;
			__taglet_index = __taglet_index + 1;
			_tmp3_ = __taglet_index;
			_tmp4_ = __taglet_size;
			if (!(_tmp3_ < _tmp4_)) {
				break;
			}
			_tmp5_ = __taglet_list;
			_tmp6_ = vala_list_get (_tmp5_, __taglet_index);
			_taglet = (ValadocContentTaglet*) _tmp6_;
			_tmp7_ = _taglet;
			_tmp8_ = _g_object_ref0 (VALADOC_TAGLETS_IS_SINCE (_tmp7_) ? ((ValadocTagletsSince*) _tmp7_) : NULL);
			taglet = _tmp8_;
			_tmp10_ = taglet;
			if (_tmp10_ == NULL) {
				_tmp9_ = TRUE;
				...
				const gchar* _tmp13_;
				_tmp11_ = taglet;
				_tmp12_ = valadoc_taglets_since_get_version (_tmp11_);
				_tmp13_ = _tmp12_;
				_tmp9_ = _tmp13_ == NULL;
			}
			if (_tmp9_) {
			...
			if (self->priv->separated == FALSE) {
				ValadocGtkDocMarkupWriter* _tmp14_;
				_tmp14_ = self->priv->writer;
				valadoc_markup_writer_text ((ValadocMarkupWriter*) _tmp14_, "\n");
			}
			_tmp15_ = self->priv->writer;
			valadoc_markup_writer_set_wrap ((ValadocMarkupWriter*) _tmp15_, FALSE);
			_tmp16_ = self->priv->writer;
			_tmp17_ = valadoc_markup_writer_text ((ValadocMarkupWriter*) _tmp16_, "\nSince: ");
			_tmp18_ = taglet;
			_tmp19_ = valadoc_taglets_since_get_version (_tmp18_);
			_tmp20_ = _tmp19_;
			valadoc_markup_writer_text (_tmp17_, _tmp20_);
			_tmp21_ = self->priv->writer;
			valadoc_markup_writer_set_wrap ((ValadocMarkupWriter*) _tmp21_, TRUE);
                                    ...
                                    ValaList* taglets)
{
	...
	first = TRUE;
	{
		...
		while (TRUE) {
			...
			ValadocContentTaglet* _tmp7_;
			ValadocTagletsSee* _tmp8_;
			gboolean _tmp9_ = FALSE;
			ValadocTagletsSee* _tmp10_;
			ValadocTagletsSee* _tmp17_;
			...
			_taglet = (ValadocContentTaglet*) _tmp6_;
			_tmp7_ = _taglet;
			_tmp8_ = _g_object_ref0 (VALADOC_TAGLETS_IS_SEE (_tmp7_) ? ((ValadocTagletsSee*) _tmp7_) : NULL);
			taglet = _tmp8_;
			_tmp10_ = taglet;
			if (_tmp10_ == NULL) {
				_tmp9_ = TRUE;
				...
				_tmp11_ = taglet;
				_tmp12_ = valadoc_taglets_see_get_symbol (_tmp11_);
				_tmp13_ = _tmp12_;
				_tmp9_ = _tmp13_ == NULL;
			}
			if (_tmp9_) {
			...
			if (first) {
				...
				_tmp14_ = self->priv->writer;
				_tmp15_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp14_, "para", NULL, (gint) 0);
				valadoc_markup_writer_text (_tmp15_, "See also: ");
			} else {
				ValadocGtkDocMarkupWriter* _tmp16_;
				_tmp16_ = self->priv->writer;
				valadoc_markup_writer_text ((ValadocMarkupWriter*) _tmp16_, ", ");
			}
			_tmp17_ = taglet;
			_tmp18_ = valadoc_taglets_see_get_symbol (_tmp17_);
			_tmp19_ = _tmp18_;
			valadoc_gtkdoc_renderer_write_docbook_link (self, (ValadocApiItem*) _tmp19_);
			first = FALSE;
			_g_object_unref0 (taglet);
			_g_object_unref0 (_taglet);
		}
	...
	if (first == FALSE) {
		ValadocGtkDocMarkupWriter* _tmp20_;
		_tmp20_ = self->priv->writer;
		valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp20_, "para");
	}
}
                                           ...
                                           ValaList* taglets)
{
	...
	first = TRUE;
	{
		...
		while (TRUE) {
			...
			_taglet = (ValadocContentTaglet*) _tmp6_;
			_tmp7_ = _taglet;
			_tmp8_ = _g_object_ref0 (VALADOC_TAGLETS_IS_THROWS (_tmp7_) ? ((ValadocTagletsThrows*) _tmp7_) : NULL);
			taglet = _tmp8_;
			_tmp10_ = taglet;
			if (_tmp10_ == NULL) {
				_tmp9_ = TRUE;
				...
				ValadocApiNode* _tmp13_;
				_tmp11_ = taglet;
				_tmp12_ = valadoc_taglets_throws_get_error_domain (_tmp11_);
				_tmp13_ = _tmp12_;
				_tmp9_ = _tmp13_ == NULL;
			}
			if (_tmp9_) {
			...
			if (first) {
				...
				_tmp14_ = self->priv->writer;
				_tmp15_ = valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp14_, "para", NULL, (gint) 0);
				_tmp16_ = valadoc_markup_writer_text (_tmp15_, "This function may throw:");
				valadoc_markup_writer_end_tag (_tmp16_, "para");
				_tmp17_ = self->priv->writer;
				valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp17_, "table", NULL, (gint) 0);
			}
			_tmp18_ = self->priv->writer;
			valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp18_, "tr", NULL, (gint) 0);
			_tmp19_ = self->priv->writer;
			valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp19_, "td", NULL, (gint) 0);
			_tmp20_ = taglet;
			_tmp21_ = valadoc_taglets_throws_get_error_domain (_tmp20_);
			_tmp22_ = _tmp21_;
			valadoc_gtkdoc_renderer_write_docbook_link (self, (ValadocApiItem*) _tmp22_);
			_tmp23_ = self->priv->writer;
			valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp23_, "td");
			_tmp24_ = self->priv->writer;
			valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) _tmp24_, "td", NULL, (gint) 0);
			_tmp25_ = taglet;
			valadoc_content_content_element_accept_children ((ValadocContentContentElement*) _tmp25_, (ValadocContentContentVisitor*) self);
			_tmp26_ = self->priv->writer;
			valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp26_, "td");
			_tmp27_ = self->priv->writer;
			valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp27_, "tr");
			first = FALSE;
			_g_object_unref0 (taglet);
			_g_object_unref0 (_taglet);
		}
	...
	if (first == FALSE) {
		ValadocGtkDocMarkupWriter* _tmp28_;
		_tmp28_ = self->priv->writer;
		valadoc_markup_writer_end_tag ((ValadocMarkupWriter*) _tmp28_, "table");
	}
}
