	...
	if (_tmp0_ != NULL) {
		...
		deplst = _tmp2_;
		{
			...
			while (TRUE) {
				...
				_tmp9_ = _pkg_list;
				_tmp10_ = vala_list_get ((ValaList*) _tmp9_, _pkg_index);
				pkg = (ValadocApiPackage*) _tmp10_;
				_tmp11_ = pkg;
				_tmp12_ = self->priv->source_package;
				if (_tmp11_ != _tmp12_) {
		...
		_tmp16_ = deplst;
		valadoc_api_package_set_dependency_list (_tmp15_, _tmp16_);
                                  ...
                                  ValadocApiVisitor* visitor)
{
	...
	g_return_if_fail (visitor != NULL);
	{
		...
		while (TRUE) {
			...
			node = (ValadocApiNode*) ((ValadocApiPackage*) _tmp7_);
			_tmp8_ = node;
			valadoc_api_node_accept (_tmp8_, visitor);
                                     ...
                                     gint path_length1)
{
	...
	}
	{
		...
		_package_list = _tmp2_;
		_tmp3_ = _package_list;
		...
		while (TRUE) {
			...
			_tmp6_ = _package_index;
			_tmp7_ = _package_size;
			if (!(_tmp6_ < _tmp7_)) {
				break;
			}
			_tmp8_ = _package_list;
			_tmp9_ = vala_list_get ((ValaList*) _tmp8_, _package_index);
			package = (ValadocApiPackage*) _tmp9_;
			_tmp10_ = package;
			_tmp11_ = valadoc_api_node_find_by_name ((ValadocApiNode*) _tmp10_, "");
			global = _tmp11_;
			_tmp12_ = global;
			if (_tmp12_ != NULL) {
				...
				_tmp13_ = global;
				_tmp14_ = valadoc_api_tree_search_relative_to (self, _tmp13_, path, (gint) path_length1);
				_g_object_unref0 (node);
				node = _tmp14_;
				_tmp15_ = node;
				if (_tmp15_ != NULL) {
...
valadoc_api_tree_get_source_package (ValadocApiTree* self)
{
	...
	if (_tmp0_ == NULL) {
		{
			...
			while (TRUE) {
				...
				_tmp9_ = pkg;
				_tmp10_ = valadoc_api_package_get_is_package (_tmp9_);
				_tmp11_ = _tmp10_;
				if (!_tmp11_) {
					ValadocApiPackage* _tmp12_;
					...
					self->priv->_source_package = _tmp13_;
					_g_object_unref0 (pkg);
					break;
				}
				_g_object_unref0 (pkg);
	...
	_tmp14_ = self->priv->_source_package;
                                 ...
                                 ValadocDocumentationParser* docparser)
{
	...
	valadoc_api_tree_parse_wiki (self, docparser);
	{
		...
		while (TRUE) {
			...
			if (valadoc_api_node_is_browsable ((ValadocApiNode*) _tmp8_, _tmp9_)) {
				ValadocApiPackage* _tmp10_;
				ValadocSettings* _tmp11_;
				_tmp10_ = pkg;
				_tmp11_ = self->priv->settings;
				valadoc_api_item_parse_comments ((ValadocApiItem*) _tmp10_, _tmp11_, docparser);
			}
			_g_object_unref0 (pkg);
		}
	}
	...
	valadoc_api_tree_check_wiki (self, docparser);
	{
		...
		while (TRUE) {
			...
			if (valadoc_api_node_is_browsable ((ValadocApiNode*) _tmp8_, _tmp9_)) {
				...
				_tmp10_ = pkg;
				_tmp11_ = self->priv->settings;
				valadoc_api_item_check_comments ((ValadocApiItem*) _tmp10_, _tmp11_, docparser);
...
{
	static volatile gsize valadoc_api_tree_inherit_doc_container_type_id__once = 0;
	if (g_once_init_enter (&valadoc_api_tree_inherit_doc_container_type_id__once)) {
		GType valadoc_api_tree_inherit_doc_container_type_id;
		valadoc_api_tree_inherit_doc_container_type_id = valadoc_api_tree_inherit_doc_container_get_type_once ();
		g_once_init_leave (&valadoc_api_tree_inherit_doc_container_type_id__once, valadoc_api_tree_inherit_doc_container_type_id);
	}
	return valadoc_api_tree_inherit_doc_container_type_id__once;
}
...
{
	static volatile gsize valadoc_api_tree_type_id__once = 0;
	if (g_once_init_enter (&valadoc_api_tree_type_id__once)) {
		GType valadoc_api_tree_type_id;
		valadoc_api_tree_type_id = valadoc_api_tree_get_type_once ();
		g_once_init_leave (&valadoc_api_tree_type_id__once, valadoc_api_tree_type_id);
	}
	return valadoc_api_tree_type_id__once;
}
