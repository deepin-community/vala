...
{
	static volatile gsize valadoc_comment_scanner_type_id__once = 0;
	if (g_once_init_enter (&valadoc_comment_scanner_type_id__once)) {
		GType valadoc_comment_scanner_type_id;
		valadoc_comment_scanner_type_id = valadoc_comment_scanner_get_type_once ();
		g_once_init_leave (&valadoc_comment_scanner_type_id__once, valadoc_comment_scanner_type_id);
	}
	return valadoc_comment_scanner_type_id__once;
}
