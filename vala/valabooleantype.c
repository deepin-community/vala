                             ...
                             ValaSourceReference* source_reference)
{
	...
	self = (ValaBooleanType*) vala_value_type_construct (object_type, (ValaTypeSymbol*) type_symbol, source_reference);
	return self;
}
...
vala_boolean_type_new (ValaStruct* type_symbol,
                       ValaSourceReference* source_reference)
{
	return vala_boolean_type_construct (VALA_TYPE_BOOLEAN_TYPE, type_symbol, source_reference);
}
...
vala_boolean_type_real_copy (ValaDataType* base)
{
	...
	_tmp3_ = _tmp2_;
	_tmp4_ = vala_boolean_type_new (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, VALA_TYPE_STRUCT, ValaStruct), _tmp3_);
	_result_ = _tmp4_;
...
{
	static volatile gsize vala_boolean_type_type_id__once = 0;
	if (g_once_init_enter (&vala_boolean_type_type_id__once)) {
		GType vala_boolean_type_type_id;
		vala_boolean_type_type_id = vala_boolean_type_get_type_once ();
		g_once_init_leave (&vala_boolean_type_type_id__once, vala_boolean_type_type_id);
	}
	return vala_boolean_type_type_id__once;
}
