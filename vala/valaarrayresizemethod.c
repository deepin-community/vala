...
{
	static volatile gsize vala_array_resize_method_type_id__once = 0;
	if (g_once_init_enter (&vala_array_resize_method_type_id__once)) {
		GType vala_array_resize_method_type_id;
		vala_array_resize_method_type_id = vala_array_resize_method_get_type_once ();
		g_once_init_leave (&vala_array_resize_method_type_id__once, vala_array_resize_method_type_id);
	}
	return vala_array_resize_method_type_id__once;
}
