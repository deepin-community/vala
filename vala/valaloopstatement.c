...
{
	static volatile gsize vala_loop_statement_type_id__volatile = 0;
	if (g_once_init_enter (&vala_loop_statement_type_id__volatile)) {
		GType vala_loop_statement_type_id;
		vala_loop_statement_type_id = vala_loop_statement_get_type_once ();
		g_once_init_leave (&vala_loop_statement_type_id__volatile, vala_loop_statement_type_id);
	}
	return vala_loop_statement_type_id__volatile;
}
