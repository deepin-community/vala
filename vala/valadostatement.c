                             ...
                             ValaSourceReference* source_reference)
{
	...
	self = (ValaDoStatement*) vala_loop_construct (object_type, condition, body, source_reference);
	return self;
}

ValaDoStatement*
vala_do_statement_new (ValaExpression* condition,
                       ValaBlock* body,
                       ValaSourceReference* source_reference)
{
	return vala_do_statement_construct (VALA_TYPE_DO_STATEMENT, condition, body, source_reference);
}
                              ...
                              ValaCodeContext* context)
{
	...
	ValaLoopStatement* _tmp120_;
	ValaLoopStatement* _tmp121_;
	...
	if (vala_expression_is_always_true (_tmp5_)) {
		...
		ValaLoopStatement* _tmp10_;
		ValaBlock* parent_block = NULL;
		ValaCodeNode* _tmp11_;
		ValaCodeNode* _tmp12_;
		ValaBlock* _tmp13_;
		ValaLoopStatement* _tmp14_;
		ValaLoopStatement* _tmp15_;
		gboolean _tmp16_;
		gboolean _tmp17_;
		...
		_tmp9_ = _tmp8_;
		_tmp10_ = vala_loop_statement_new (_tmp7_, _tmp9_);
		loop = _tmp10_;
	...
	_tmp42_ = vala_loop_get_condition ((ValaLoop*) self);
	_tmp43_ = _tmp42_;
	...
	_tmp49_ = vala_loop_get_condition ((ValaLoop*) self);
	_tmp50_ = _tmp49_;
	...
	true_block = _tmp53_;
	_tmp54_ = true_block;
	_tmp55_ = vala_loop_get_condition ((ValaLoop*) self);
	_tmp56_ = _tmp55_;
	...
	_tmp62_ = true_block;
	_tmp63_ = vala_loop_get_condition ((ValaLoop*) self);
	_tmp64_ = _tmp63_;
	...
	if_stmt = _tmp67_;
	_tmp68_ = vala_loop_get_condition ((ValaLoop*) self);
	_tmp69_ = _tmp68_;
	...
	first_if = _tmp90_;
	_tmp91_ = vala_loop_get_body ((ValaLoop*) self);
	_tmp92_ = _tmp91_;
	_tmp93_ = first_if;
	vala_block_insert_statement (_tmp92_, 0, (ValaStatement*) _tmp93_);
	_tmp94_ = vala_loop_get_body ((ValaLoop*) self);
	_tmp95_ = _tmp94_;
	_tmp96_ = first_local;
	...
	_tmp115_ = block;
	_tmp116_ = vala_loop_get_body ((ValaLoop*) self);
	_tmp117_ = _tmp116_;
	_tmp118_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
	_tmp119_ = _tmp118_;
	_tmp120_ = vala_loop_statement_new (_tmp117_, _tmp119_);
	_tmp121_ = _tmp120_;
...
vala_do_statement_get_type_once (void)
{
	...
	vala_do_statement_type_id = g_type_register_static (VALA_TYPE_LOOP, "ValaDoStatement", &g_define_type_info, 0);
