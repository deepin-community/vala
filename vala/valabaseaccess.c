                             ...
                             ValaCodeContext* context)
{
			...
			if (_tmp40_) {
				...
				if (_tmp72_) {
				...
				} else {
					{
						...
						_base_type_list = _tmp107_;
						_tmp108_ = _base_type_list;
						_tmp109_ = vala_collection_get_size ((ValaCollection*) _tmp108_);
						_tmp110_ = _tmp109_;
						_base_type_size = _tmp110_;
						_base_type_index = -1;
						while (TRUE) {
							gint _tmp111_;
							gint _tmp112_;
							...
							_tmp111_ = _base_type_index;
							_tmp112_ = _base_type_size;
							if (!(_tmp111_ < _tmp112_)) {
								break;
							}
							_tmp113_ = _base_type_list;
							_tmp114_ = vala_list_get (_tmp113_, _base_type_index);
							base_type = (ValaDataType*) _tmp114_;
							_tmp115_ = base_type;
							...
							if (VALA_IS_CLASS (_tmp117_)) {
								...
								_tmp120_ = _tmp119_;
								vala_expression_set_value_type ((ValaExpression*) self, _tmp120_);
								_vala_code_node_unref0 (_tmp120_);
								_tmp121_ = vala_expression_get_value_type ((ValaExpression*) self);
								_tmp122_ = _tmp121_;
								vala_data_type_set_value_owned (_tmp122_, FALSE);
							}
	...
	_tmp126_ = _tmp125_;
	vala_expression_set_symbol_reference ((ValaExpression*) self, (ValaSymbol*) _tmp126_);
