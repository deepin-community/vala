...
{
	static volatile gsize vala_token_type_type_id__once = 0;
	if (g_once_init_enter (&vala_token_type_type_id__once)) {
		GType vala_token_type_type_id;
		vala_token_type_type_id = vala_token_type_get_type_once ();
		g_once_init_leave (&vala_token_type_type_id__once, vala_token_type_type_id);
	}
	return vala_token_type_type_id__once;
}
