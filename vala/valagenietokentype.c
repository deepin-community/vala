...
{
	static volatile gsize vala_genie_token_type_type_id__once = 0;
	if (g_once_init_enter (&vala_genie_token_type_type_id__once)) {
		GType vala_genie_token_type_type_id;
		vala_genie_token_type_type_id = vala_genie_token_type_get_type_once ();
		g_once_init_leave (&vala_genie_token_type_type_id__once, vala_genie_token_type_type_id);
	}
	return vala_genie_token_type_type_id__once;
}
