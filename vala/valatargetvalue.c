...
{
	static volatile gsize vala_target_value_type_id__once = 0;
	if (g_once_init_enter (&vala_target_value_type_id__once)) {
		GType vala_target_value_type_id;
		vala_target_value_type_id = vala_target_value_get_type_once ();
		g_once_init_leave (&vala_target_value_type_id__once, vala_target_value_type_id);
	}
	return vala_target_value_type_id__once;
}
