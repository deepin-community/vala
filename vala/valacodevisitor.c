...
static void vala_code_visitor_real_visit_loop_statement (ValaCodeVisitor* self,
...
static void vala_code_visitor_real_visit_with_statement (ValaCodeVisitor* self,
...
vala_code_visitor_visit_source_file (ValaCodeVisitor* self,
                                     ValaSourceFile* source_file)
{
	ValaCodeVisitorClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_source_file) {
		_klass_->visit_source_file (self, source_file);
	}
}
                                   ...
                                   ValaNamespace* ns)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_namespace) {
		_klass_->visit_namespace (self, ns);
	}
}
                               ...
                               ValaClass* cl)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_class) {
		_klass_->visit_class (self, cl);
	}
}
                                ...
                                ValaStruct* st)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_struct) {
		_klass_->visit_struct (self, st);
	}
}
                                   ...
                                   ValaInterface* iface)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_interface) {
		_klass_->visit_interface (self, iface);
	}
}
                              ...
                              ValaEnum* en)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_enum) {
		_klass_->visit_enum (self, en);
	}
}
                                    ...
                                    ValaEnumValue* ev)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_enum_value) {
		_klass_->visit_enum_value (self, ev);
	}
}
                                      ...
                                      ValaErrorDomain* edomain)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_error_domain) {
		_klass_->visit_error_domain (self, edomain);
	}
}
                                    ...
                                    ValaErrorCode* ecode)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_error_code) {
		_klass_->visit_error_code (self, ecode);
	}
}
                                  ...
                                  ValaDelegate* d)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_delegate) {
		_klass_->visit_delegate (self, d);
	}
}
                                  ...
                                  ValaConstant* c)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_constant) {
		_klass_->visit_constant (self, c);
	}
}
                               ...
                               ValaField* f)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_field) {
		_klass_->visit_field (self, f);
	}
}
                                ...
                                ValaMethod* m)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_method) {
		_klass_->visit_method (self, m);
	}
}
                                         ...
                                         ValaCreationMethod* m)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_creation_method) {
		_klass_->visit_creation_method (self, m);
	}
}
                                          ...
                                          ValaParameter* p)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_formal_parameter) {
		_klass_->visit_formal_parameter (self, p);
	}
}
                                  ...
                                  ValaProperty* prop)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_property) {
		_klass_->visit_property (self, prop);
	}
}
                                           ...
                                           ValaPropertyAccessor* acc)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_property_accessor) {
		_klass_->visit_property_accessor (self, acc);
	}
}
                                ...
                                ValaSignal* sig)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_signal) {
		_klass_->visit_signal (self, sig);
	}
}
                                     ...
                                     ValaConstructor* c)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_constructor) {
		_klass_->visit_constructor (self, c);
	}
}
                                    ...
                                    ValaDestructor* d)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_destructor) {
		_klass_->visit_destructor (self, d);
	}
}
                                        ...
                                        ValaTypeParameter* p)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_type_parameter) {
		_klass_->visit_type_parameter (self, p);
	}
}
                                         ...
                                         ValaUsingDirective* ns)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_using_directive) {
		_klass_->visit_using_directive (self, ns);
	}
}
                                   ...
                                   ValaDataType* type)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_data_type) {
		_klass_->visit_data_type (self, type);
	}
}
                               ...
                               ValaBlock* b)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_block) {
		_klass_->visit_block (self, b);
	}
}
                                         ...
                                         ValaEmptyStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_empty_statement) {
		_klass_->visit_empty_statement (self, stmt);
	}
}
                                               ...
                                               ValaDeclarationStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_declaration_statement) {
		_klass_->visit_declaration_statement (self, stmt);
	}
}
                                        ...
                                        ValaLocalVariable* local)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_local_variable) {
		_klass_->visit_local_variable (self, local);
	}
}
                                          ...
                                          ValaInitializerList* list)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_initializer_list) {
		_klass_->visit_initializer_list (self, list);
	}
}
                                              ...
                                              ValaExpressionStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_expression_statement) {
		_klass_->visit_expression_statement (self, stmt);
	}
}
                                      ...
                                      ValaIfStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_if_statement) {
		_klass_->visit_if_statement (self, stmt);
	}
}
                                          ...
                                          ValaSwitchStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_switch_statement) {
		_klass_->visit_switch_statement (self, stmt);
	}
}
                                        ...
                                        ValaSwitchSection* section)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_switch_section) {
		_klass_->visit_switch_section (self, section);
	}
}
                                      ...
                                      ValaSwitchLabel* label)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_switch_label) {
		_klass_->visit_switch_label (self, label);
	}
}
 ...
 */
static void
vala_code_visitor_real_visit_loop_statement (ValaCodeVisitor* self,
                                             ValaLoopStatement* stmt)
{
	g_return_if_fail (stmt != NULL);
}
...
void
vala_code_visitor_visit_loop_statement (ValaCodeVisitor* self,
                                        ValaLoopStatement* stmt)
{
	ValaCodeVisitorClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_loop_statement) {
		_klass_->visit_loop_statement (self, stmt);
	}
}
                                         ...
                                         ValaWhileStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_while_statement) {
		_klass_->visit_while_statement (self, stmt);
	}
}
                                      ...
                                      ValaDoStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_do_statement) {
		_klass_->visit_do_statement (self, stmt);
	}
}
                                       ...
                                       ValaForStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_for_statement) {
		_klass_->visit_for_statement (self, stmt);
	}
}
                                           ...
                                           ValaForeachStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_foreach_statement) {
		_klass_->visit_foreach_statement (self, stmt);
	}
}
                                         ...
                                         ValaBreakStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_break_statement) {
		_klass_->visit_break_statement (self, stmt);
	}
}
                                            ...
                                            ValaContinueStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_continue_statement) {
		_klass_->visit_continue_statement (self, stmt);
	}
}
                                          ...
                                          ValaReturnStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_return_statement) {
		_klass_->visit_return_statement (self, stmt);
	}
}
                                         ...
                                         ValaYieldStatement* y)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_yield_statement) {
		_klass_->visit_yield_statement (self, y);
	}
}
                                         ...
                                         ValaThrowStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_throw_statement) {
		_klass_->visit_throw_statement (self, stmt);
	}
}
                                       ...
                                       ValaTryStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_try_statement) {
		_klass_->visit_try_statement (self, stmt);
	}
}
                                      ...
                                      ValaCatchClause* clause)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_catch_clause) {
		_klass_->visit_catch_clause (self, clause);
	}
}
                                        ...
                                        ValaLockStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_lock_statement) {
		_klass_->visit_lock_statement (self, stmt);
	}
}
                                          ...
                                          ValaUnlockStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_unlock_statement) {
		_klass_->visit_unlock_statement (self, stmt);
	}
}
 ...
 */
static void
vala_code_visitor_real_visit_with_statement (ValaCodeVisitor* self,
                                             ValaWithStatement* stmt)
{
	g_return_if_fail (stmt != NULL);
}
...
void
vala_code_visitor_visit_with_statement (ValaCodeVisitor* self,
                                        ValaWithStatement* stmt)
{
	ValaCodeVisitorClass* _klass_;
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_with_statement) {
		_klass_->visit_with_statement (self, stmt);
	}
}
                                          ...
                                          ValaDeleteStatement* stmt)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_delete_statement) {
		_klass_->visit_delete_statement (self, stmt);
	}
}
                                    ...
                                    ValaExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_expression) {
		_klass_->visit_expression (self, expr);
	}
}
                                                   ...
                                                   ValaArrayCreationExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_array_creation_expression) {
		_klass_->visit_array_creation_expression (self, expr);
	}
}
                                         ...
                                         ValaBooleanLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_boolean_literal) {
		_klass_->visit_boolean_literal (self, lit);
	}
}
                                           ...
                                           ValaCharacterLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_character_literal) {
		_klass_->visit_character_literal (self, lit);
	}
}
                                         ...
                                         ValaIntegerLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_integer_literal) {
		_klass_->visit_integer_literal (self, lit);
	}
}
                                      ...
                                      ValaRealLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_real_literal) {
		_klass_->visit_real_literal (self, lit);
	}
}
                                       ...
                                       ValaRegexLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_regex_literal) {
		_klass_->visit_regex_literal (self, lit);
	}
}
                                        ...
                                        ValaStringLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_string_literal) {
		_klass_->visit_string_literal (self, lit);
	}
}
                                  ...
                                  ValaTemplate* tmpl)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_template) {
		_klass_->visit_template (self, tmpl);
	}
}
                               ...
                               ValaTuple* tuple)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_tuple) {
		_klass_->visit_tuple (self, tuple);
	}
}
                                      ...
                                      ValaNullLiteral* lit)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_null_literal) {
		_klass_->visit_null_literal (self, lit);
	}
}
                                       ...
                                       ValaMemberAccess* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_member_access) {
		_klass_->visit_member_access (self, expr);
	}
}
                                     ...
                                     ValaMethodCall* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_method_call) {
		_klass_->visit_method_call (self, expr);
	}
}
                                        ...
                                        ValaElementAccess* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_element_access) {
		_klass_->visit_element_access (self, expr);
	}
}
                                          ...
                                          ValaSliceExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_slice_expression) {
		_klass_->visit_slice_expression (self, expr);
	}
}
                                     ...
                                     ValaBaseAccess* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_base_access) {
		_klass_->visit_base_access (self, expr);
	}
}
                                            ...
                                            ValaPostfixExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_postfix_expression) {
		_klass_->visit_postfix_expression (self, expr);
	}
}
                                                    ...
                                                    ValaObjectCreationExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_object_creation_expression) {
		_klass_->visit_object_creation_expression (self, expr);
	}
}
                                           ...
                                           ValaSizeofExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_sizeof_expression) {
		_klass_->visit_sizeof_expression (self, expr);
	}
}
                                           ...
                                           ValaTypeofExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_typeof_expression) {
		_klass_->visit_typeof_expression (self, expr);
	}
}
                                          ...
                                          ValaUnaryExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_unary_expression) {
		_klass_->visit_unary_expression (self, expr);
	}
}
                                         ...
                                         ValaCastExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_cast_expression) {
		_klass_->visit_cast_expression (self, expr);
	}
}
                                        ...
                                        ValaNamedArgument* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_named_argument) {
		_klass_->visit_named_argument (self, expr);
	}
}
                                             ...
                                             ValaPointerIndirection* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_pointer_indirection) {
		_klass_->visit_pointer_indirection (self, expr);
	}
}
                                              ...
                                              ValaAddressofExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_addressof_expression) {
		_klass_->visit_addressof_expression (self, expr);
	}
}
                                                       ...
                                                       ValaReferenceTransferExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_reference_transfer_expression) {
		_klass_->visit_reference_transfer_expression (self, expr);
	}
}
                                           ...
                                           ValaBinaryExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_binary_expression) {
		_klass_->visit_binary_expression (self, expr);
	}
}
                                    ...
                                    ValaTypeCheck* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_type_check) {
		_klass_->visit_type_check (self, expr);
	}
}
                                                ...
                                                ValaConditionalExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_conditional_expression) {
		_klass_->visit_conditional_expression (self, expr);
	}
}
                                           ...
                                           ValaLambdaExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_lambda_expression) {
		_klass_->visit_lambda_expression (self, expr);
	}
}
                                    ...
                                    ValaAssignment* a)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_assignment) {
		_klass_->visit_assignment (self, a);
	}
}
                                             ...
                                             ValaExpression* expr)
{
	...
	g_return_if_fail (self != NULL);
	_klass_ = VALA_CODE_VISITOR_GET_CLASS (self);
	if (_klass_->visit_end_full_expression) {
		_klass_->visit_end_full_expression (self, expr);
	}
}
                              ...
                              gpointer klass_data)
{
	...
	((ValaCodeVisitorClass *) klass)->visit_loop_statement = (void (*) (ValaCodeVisitor*, ValaLoopStatement*)) vala_code_visitor_real_visit_loop_statement;
	...
	((ValaCodeVisitorClass *) klass)->visit_with_statement = (void (*) (ValaCodeVisitor*, ValaWithStatement*)) vala_code_visitor_real_visit_with_statement;
