...
static void vala_addressof_expression_set_inner (ValaAddressofExpression* self,
                                      ...
                                      ValaCodeContext* context)
{
	...
	if (vala_data_type_is_reference_type_or_type_parameter (_tmp35_)) {
		...
		_tmp43_ = _tmp42_;
		_tmp44_ = vala_pointer_type_new ((ValaDataType*) _tmp41_, _tmp43_);
		_tmp45_ = _tmp44_;
		vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp45_);
		...
		_tmp46_ = vala_addressof_expression_get_inner (self);
		_tmp47_ = _tmp46_;
		_tmp48_ = vala_expression_get_value_type (_tmp47_);
		_tmp49_ = _tmp48_;
		_tmp50_ = vala_code_node_get_source_reference ((ValaCodeNode*) self);
		_tmp51_ = _tmp50_;
		_tmp52_ = vala_pointer_type_new (_tmp49_, _tmp51_);
		_tmp53_ = _tmp52_;
		vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp53_);
