...
static void vala_comment_set_source_reference (ValaComment* self,
                                        ValaSourceReference* value);
static void vala_comment_set_content (ValaComment* self,
                               const gchar* value);
...
{
	static volatile gsize vala_comment_type_id__once = 0;
	if (g_once_init_enter (&vala_comment_type_id__once)) {
		GType vala_comment_type_id;
		vala_comment_type_id = vala_comment_get_type_once ();
		g_once_init_leave (&vala_comment_type_id__once, vala_comment_type_id);
	}
	return vala_comment_type_id__once;
}
