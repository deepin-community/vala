...
{
	static volatile gsize vala_generic_destroy_field_type_id__once = 0;
	if (g_once_init_enter (&vala_generic_destroy_field_type_id__once)) {
		GType vala_generic_destroy_field_type_id;
		vala_generic_destroy_field_type_id = vala_generic_destroy_field_get_type_once ();
		g_once_init_leave (&vala_generic_destroy_field_type_id__once, vala_generic_destroy_field_type_id);
	}
	return vala_generic_destroy_field_type_id__once;
}
