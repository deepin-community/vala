                          ...
                          ValaCodeNode* node_reference)
{
	...
	is_generic = FALSE;
	{
		...
		while (TRUE) {
			...
			_tmp36_ = _tmp35_;
			if (vala_data_type_is_generic (_tmp36_)) {
				is_generic = TRUE;
			}
	...
	if (is_generic) {
		...
		_tmp38_ = _tmp37_;
		cl = G_TYPE_CHECK_INSTANCE_CAST (_tmp38_, VALA_TYPE_OBJECT_TYPE_SYMBOL, ValaObjectTypeSymbol);
		{
			...
			_tmp39_ = cl;
			_tmp40_ = vala_object_type_symbol_get_type_parameters (_tmp39_);
			...
			while (TRUE) {
				...
				param = (ValaParameter*) _tmp65_;
				{
					...
					while (TRUE) {
						...
						_tmp74_ = vala_list_get (_tmp73_, _type_param_index);
						type_param = (ValaTypeParameter*) _tmp74_;
						_tmp75_ = param;
						_tmp76_ = vala_variable_get_variable_type ((ValaVariable*) _tmp75_);
						_tmp77_ = _tmp76_;
						_tmp78_ = cl;
						_tmp79_ = vala_object_type_symbol_get_type_parameters (_tmp78_);
						_tmp80_ = cl;
						_tmp81_ = type_param;
						_tmp82_ = vala_symbol_get_name ((ValaSymbol*) _tmp81_);
						_tmp83_ = _tmp82_;
						_tmp84_ = vala_list_get (_tmp79_, vala_typesymbol_get_type_parameter_index ((ValaTypeSymbol*) _tmp80_, _tmp83_));
						_tmp85_ = (ValaTypeParameter*) _tmp84_;
						_tmp86_ = type_param;
						vala_data_type_replace_type_parameter (_tmp77_, _tmp85_, _tmp86_);
